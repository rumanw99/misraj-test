        ...
        >
            <g id="essential">
                ...
                <path
                    ...
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M9.58002 17C9.58002 16.5858 9.9158 16.25 10.33 16.25H13.66C14.0742 16.25 14.41 16.5858 14.41 17C14.41 17.4142 14.0742 17.75 13.66 17.75H10.33C9.9158 17.75 9.58002 17.4142 9.58002 17Z"
                    fill="black"
                    fill-opacity="0.88"
                />
                <path
